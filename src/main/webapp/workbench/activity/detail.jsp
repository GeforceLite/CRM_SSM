		...
		$.ajax({
			...
			success:function (data) {
				...
				$.each(data,function (i,n){
					...
					html+='<font color="gray">市场活动</font> <font color="gray">-</font> <b>${a.name}</b> <small style="color: gray;">'+(n.editFlag==0?n.createTime:n.editTime)+'由  '+(n.editFlag==0?n.createBy:n.editBy)+' '+(n.editFlag==0?"创建":"修改")+'</small>';
				...
				//before和append都是添加的意思，append是从当前div往下添加，before是从当前div往上添加
				//为什么不用append？因为最上方有个分割线图片不好调样式
