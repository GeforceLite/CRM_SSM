...
//jsp也算是Servlet，所以可以用request等对象（JSP的9大内置对象
//包括四个作用域对象等等，request，response，Pagecontext，session，page，config，application
//out，exception
// 不用声明直接用
...
EL表达式中pageContext可以取得其他8个内置对象，因为没有作用域对象，不像JSP
EL表达式用pageContext.getXXX()等方法可以实现
*/
%>
<!DOCTYPE html>
<html>
